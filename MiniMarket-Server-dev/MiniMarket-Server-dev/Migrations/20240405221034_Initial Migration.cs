    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeCodes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    DeactivationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CompanyCodeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Users_EmployeeCodes_CompanyCodeId",
                        column: x => x.CompanyCodeId,
                        principalTable: "EmployeeCodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
