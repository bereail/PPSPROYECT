...
namespace MiniMarket_API.Data.Repositories
{
    public class SaleOrderRepository : ISaleOrderRepository
    {
        ...
        public async Task<SaleOrder> CreateOrderAsync(SaleOrder order)
        {
            ...
            order.ExpirationTime = DateTime.UtcNow.AddDays(1);
        ...
        public async Task<SaleOrder?> SetOrderStatusAsync(Guid id, Guid userId, int newStatus)
        {
            var getOrder = await _context.Orders
                .Include(o => o.Details)
                .Include(o => o.DeliveryAddress)
                .FirstOrDefaultAsync(o => o.Id == id && o.UserId == userId && o.Status == 0);
        ...
        public async Task<ICollection<Guid>> GetPendingOrderIdsByUserIdAsync(Guid userId)
        {
